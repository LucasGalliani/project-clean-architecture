...
public class UsuarioConfig {
    ...
    @Bean
    public RepositorioDeUsuarioJpa repositorioDeUsuarioJpa(UsuarioRepository usuarioRepository, UsuarioEntityMapper usuarioEntityMapper){
        return new RepositorioDeUsuarioJpa(usuarioRepository,usuarioEntityMapper);
    }

    @Bean
    public UsuarioEntityMapper retornaMapper(){
